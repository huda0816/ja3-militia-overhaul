return PlaceObj('ModDef', {
	...
	'last_changes', 'Update 2.2\n\n[list]\n[*]Renamed and reordered options\n[*]Added option to make "Far from Home" optional\n[*]Fixed bug where shop was initialized too early\n[/list]',
	'dependencies', {
