return PlaceObj('ModDef', {
	...
	'last_changes', "Update 3\n\n[list]\n[*]Fixed some minor bugs\n[*]Updated mod to work with 1.3\n[*]Added new Operations\n[*]Added system to which limits the number of militia soldiers\n[*]Reduced loyalty loss if you retreat\n[*]Added loyalty gain if you train militia\n[/list]",
	'dependencies', {
