return PlaceObj('ModDef', {
	...
	'last_changes', "Update 1.3.1.1\n\nRevert to table inventory",
	'dependencies', {
	...
	'code', {
		...
		"Code/1Options.lua",
		"Code/1_MilitiaShopCouponCodes.lua",
		"Code/1_MilitiaShopDeliveryTypes.lua",
		"Code/1_MilitiaShopInventory.lua",
		"Code/1_MilitiaShopCategories.lua",
