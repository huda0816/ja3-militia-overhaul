return PlaceObj('ModDef', {
	...
	'last_changes', "Update 5.15\n\n[list]\n[*]Added underground sectors to nodowner function\n[*]Fixed problem with militia transfer which stopped repair operations\n[/list]",
	'dependencies', {},
	'id', "LXPER6t",
	'author', "permanent666",
	'version_major', 5,
