return PlaceObj('ModDef', {
	...
	'last_changes', "Update 4.1\n\n[list]\n[*]Added option to disable randomized militia weapons\n[*]Changed shop price modifier option to be able to decrease the prices\n[*]Fixed bug with shop emails\n[/list]",
	'dependencies', {},
	'id', "LXPER6t",
	'author', "permanent666",
	'version_major', 4,
