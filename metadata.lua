return PlaceObj('ModDef', {
	...
	'last_changes', "Update 5.11\n\n[list]\n[*]Added check to prevent units with valuabes or quest items to get downed\n[*]Fixed problem with militia shop sector link in emails\n[/list]",
	'dependencies', {},
	'id', "LXPER6t",
	'author', "permanent666",
	'version_major', 5,
