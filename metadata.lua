return PlaceObj('ModDef', {
	...
	'last_changes', "Update 3.9\n\n[list]\n[*]Added an indicator which shows how much soldiers have to be stationed in a city to not losing loyalty\n[*]Captured soldiers are dropping loot now\n[*]You can now send prisoners to local authorities, needed if you do not have a prison or no space left\n[*]Militia shop delivers now in every sector which includes a militia base\n[/list]",
	'dependencies', {
