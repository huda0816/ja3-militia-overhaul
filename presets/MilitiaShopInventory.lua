...
PlaceObj('HUDAMilitiaShopInventoryItem', {
    ...
    availability = 100,
    description =
    "The 7.62 WP Basic rounds are standard ammunition for firearms chambered in 7.62x39mm. They offer reliable performance in a variety of situations."
})
...
PlaceObj('HUDAMilitiaShopInventoryItem', {
    ...
    availability = 100,
    description =
    "The 7.62 WP Armor-Piercing (AP) rounds are known for their ability to penetrate armor and deliver devastating force. They are favored by marksmen and snipers."
})
...
PlaceObj('HUDAMilitiaShopInventoryItem', {
    ...
    availability = 70,
    description =
    "The Proximity Detonator can be attached to explosives to trigger detonation when a target enters its proximity. It's a versatile tool for demolitions."
})
...
PlaceObj('HUDAMilitiaShopInventoryItem', {
    ...
    availability = 80,
    description =
    "The Remote Detonator can be attached to explosives to trigger detonation remotely. It's a versatile tool for demolitions."
})
...
PlaceObj('HUDAMilitiaShopInventoryItem', {
    ...
    availability = 80,
    description =
    "The Time Detonator can be attached to explosives to trigger detonation after a set amount of time. It's a versatile tool for demolitions."
})
