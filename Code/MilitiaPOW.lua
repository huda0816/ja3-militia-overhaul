...
--     local pow = unit:GetCaptureTarget()
--     unit:RemoveStatusEffect("Capturing")
--     local pos = pow:GetPosXYZ()
--     local container = GetDropContainer(pow, pos + point(const.SlabSizeX, const.SlabSizeY, 0))
...
--     Description = T(1344589948720816, --[[CombatAction StopBandaging Description]] "Cancel the capturing action. The unit will be able to move but not regain any more HP."),
