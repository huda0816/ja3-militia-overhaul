if FirstLoad then
    ...
    local OriginalFunc = SectorOperationUI[1][1].func
    ...
    CustomSettingsMod.Utils.XTemplate_FindElementsByProp(XTemplates["SectorOperationsUI"], "Id", "idActionBar").element.ButtonTemplate =
    "PDAHUDAOPActionButton"
